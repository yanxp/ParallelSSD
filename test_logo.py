...
def test_net(num_classes,save_folder, net, detector, cuda, testset, transform, max_per_image=300, thresh=0.005):
...
if __name__ == '__main__':
    ...
    if args.dataset == 'Logo':
        ...
        print('Only Logo and COCO dataset are supported now!')
    if args.cuda:
        net = net.cuda()
    ...
    test_net(num_classes,save_folder, net, detector, args.cuda, testset,
