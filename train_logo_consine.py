...
num_classes = (22, 81)[args.dataset == 'COCO']
...
#                      momentum=args.momentum, weight_decay=args.weight_decay)
##### and consine learning rate ######
lr_scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer,T_max=40,eta_min=4e-8)
...
def train():
    ...
    stepvalues_Logo = (75 * epoch_size, 100 * epoch_size, 125 * epoch_size)
